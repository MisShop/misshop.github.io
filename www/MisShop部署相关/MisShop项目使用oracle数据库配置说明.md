...
![images](http://www.misshop.com.cn/res/doc/orc1.png)    



2、复制oracle数据库连接文件：
a、修改文件：project/db.ini  
![images](http://www.misshop.com.cn/res/doc/orc2.png)    

  
  
b、修改内容：复制db_proto_oracle.ini的内容，覆盖project/db.ini中的内容 
  文件位置：WebRoot/WEB-INF/classes/proto/db_proto_oracle.ini  
  ![images](http://www.misshop.com.cn/res/doc/orc3.png)    
  
  
3、配置oracle数据库连接文件：
配置项目使用的数据库jdbc连接：url/user/password/schema/dsName  
![images](http://www.misshop.com.cn/res/doc/orc4.png)      
